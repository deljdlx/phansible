...
{
    $httpMachineIP=getVagrantIP(__DIR__.'/../machine/window/http');
    echo "Virtual HTTP machine IP : ".$httpMachineIP."\n";

    $bddMachineIP=getVagrantIP(__DIR__.'/../machine/window/bdd');
    echo "Virtual BDD machine IP : ".$bddMachineIP."\n";


    $httpSSHKey=realpath(__DIR__.'/../machine/window/http/.vagrant/machines/default/virtualbox/private_key');
    ...
    $bddSSHKey=realpath(__DIR__.'/../machine/window/bdd/.vagrant/machines/default/virtualbox/private_key');
